...
const Header = () => {
  ...
  return (
    <header className="py-8 bg-[#0C3B45]/5">
      <div className="w-[90%] mx-auto lg:flex md:flex justify-between hidden">
        <img src={logo} alt="" className="w-[235px] h-[43px]" />
        <nav>
          <NavLink
            to="/"
            className="text-[#0F160F]/90 hover:text-[#0C3B45] hover:font-[700] mr-10 text-[18px]"
          >
            Home
          </NavLink>
          <NavLink
          ...
          <a
            href="#about-us"
            className="text-[#0F160F]/90  hover:text-[#0C3B45] hover:font-[700] text-[18px]"
          >
            About Us
          </a>
        </nav>
      ...
      <div className="w-[95%] mx-auto flex justify-between lg:hidden md:hidden relative">
        ...
        {isOpen && (<nav className="flex flex-col bg-white p-8 py-12 h-[100vh] w-[100%] absolute top-20 left-0 bg-baseBlack/70 z-50">
          <NavLink
            to="/"
            className="text-[#0F160F]/90 hover:text-[#0C3B45] hover:font-[700] mb-6 text-[18px]"
          >
            Home
          </NavLink>
          <NavLink
