...
const MarketplaceDetails = () => {
  ...
  return (
    <main>
      <Banner />
      {transaction ? (<div className='w-[100%] mx-auto'>
        ...
        <section className='flex lg:flex-row md:flex-row flex-col justify-between'>
          ...
          <div className='text-[#0F160F] lg:w-[52%] md:w-[52%] w-[100%]'>
            ...
            <p className='font-titiliumweb mb-4 font-bold text-[#0C3B45] lg:text-[24px] md:text-[24px] text-[20px]'>{formatUnits(transaction.price)} AMB (per unit of measure) </p>
