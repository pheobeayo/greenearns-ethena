...
const Transactions = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      const deploymentBlockNumber = 16222545; 
            ...
            <div key={index} className="border p-4 mb-4 rounded-lg shadow-md lg:w-[32%] md:w-[32%] w-[100%]">
              ...
              {userPurchase ? (
                <div>
                  ...
                  <p className='flex justify-between my-4 font-bold'>Price <span>{formatUnits(userPurchase.price)}AMB</span> </p>
                </div>
              ) : (
            ...
            <div key={index} className="border p-4 mb-4 rounded-lg shadow-md lg:w-[32%] md:w-[32%] w-[100%]">
              {userApproval ? (
                <div>
                  ...
                  <p className='flex justify-between my-4 font-bold'>Price <span>{formatUnits(userApproval.price)}AMB</span> </p>
                </div>
              ) : (
                <p>Product details not available.</p>
              )}
